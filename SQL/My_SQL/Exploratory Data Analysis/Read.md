...
-- Selecting maximum total laid off and percentage laid off
...
-- Selecting the company and total laid off
...
FROM worlds_layoffs.layoffs_staging2;
-- Industry and total laid off
SELECT industry,sum(Total_laid_off)
FROM worlds_layoffs.layoffs_staging2
GROUP BY industry
ORDER BY 2 DESC;
-- Country and total laid off
SELECT COUNTRY,sum(Total_laid_off)
FROM worlds_layoffs.layoffs_staging2
GROUP BY country
ORDER BY 2 DESC;
-- Year and total laid off
